...
const targetFile = path.join(__dirname, '..', 'src', 'js', 'js_main.jsx');
...
if (duplicates.length > 0) {
  console.error('Duplicate exported function declarations found in src/js/js_main.jsx:');
...
console.log('No duplicate exported function declarations found in src/js/js_main.jsx');
